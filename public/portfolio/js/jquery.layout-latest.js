...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	spacing_open:			12			// space between pane and adjacent panes - when pane is 'open'
	...
	,	fxName:					"none" 	// ('none' or blank), slide, drop, scale -- only relevant to 'open' & 'close', NOT 'size'
